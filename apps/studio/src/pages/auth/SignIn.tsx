...
export default function SignIn() {
  ...
  return (
    <AuthLayout>
      <AuthTitle subtitle="Sign in to manage your creator profile and events.">
        Sign in
      </AuthTitle>
      ...
      <p className="mt-4 text-center text-xs text-white/60">
        Same credentials as the user app? Sign in here — you'll just go through
        creator setup the first time.
      </p>
    </AuthLayout>
  );
}
