...
export function AdminLayout() {
    ...
    <>
      ...
      <div className="relative px-5 pt-[18px] pb-3">
        <Link
          ...
          onClick={closeMobile}
          className="block"
          aria-label="LiveRush Admin home"
        >
      ...
      <nav className="relative flex-1 overflow-y-auto px-3 pb-3">
        ...
        >
          <div className="-mx-1 -mt-1 flex items-center gap-3 px-1 py-1">
            <div className="flex h-11 w-11 flex-shrink-0 items-center justify-center rounded-full bg-white/20 font-heading text-base font-bold ring-2 ring-white/40">
            ...
            <div className="min-w-0 flex-1">
              ...
              <p className="truncate text-[11px] text-white/70">Super admin</p>
            </div>
          </div>
      ...
      <div className="relative px-5 py-4">
        <p className="text-[11px] leading-tight text-white/75">
          © {new Date().getFullYear()} LiveRush Admin
        </p>
      </div>
    </>
  );
  ...
  return (
    <div className="relative flex h-[100dvh] overflow-hidden bg-background">
      {/* Doodle-pattern background — same asset as user-app + studio */}
      <div
        aria-hidden
      ...
      <header className="absolute inset-x-0 top-0 z-30 flex h-14 items-center justify-between border-b border-border/40 bg-card/80 px-4 backdrop-blur lg:hidden">
        <Link to="/" aria-label="LiveRush Admin home" className="flex items-center gap-2">
